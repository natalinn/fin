...
(function() {
    ...
    function init() {
        var mapOptions = {
            ...
            scaleControl: false,
            draggable: false,
            center: new google.maps.LatLng(49.82823871, 23.95774841),
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(49.82823871, 23.95774841),
            map: map,
            icon: 'img/logo-icon.png',
            title: "TheHam"
        });

        var contentString = 'Hello world! TheHam is here!';
